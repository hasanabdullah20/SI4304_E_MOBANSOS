            ...
            <div class="ml-5">
                ...
                <form action="/registRT" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="rt" id="rt" placeholder="Masukan angka RT" />
                    </div>
                    <div class="form-group">
                        <label for="rw">Rw</label>
                        <input class="form-control" type="text" name="rw" id="rw" placeholder="Masukan angka RW" />
                    </div>
                    <div class="form-group">
